                   ...
                   <!-- Advanced Tables -->
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                             Laporan Peminjaman Tata Naskah
                        </div>
                        <div class="panel-body">						
							<form method="post" class="" action="<?php echo site_url()?>/pinjam/cetakLaporan/">
								...
								<div class="form-group row">
								    <label class="control-label col-md-2">Pelaksana:</label>
									<div class="col-md-4">
									<select name="pelaksana" id="pelaksana" required class="form-control select2" >
										<option value="">--Silahkan Pilih--</option>
								...
								<div class="form-group row">
									...
									<div class="col-sm-4 controls">
									  <div class="input-group">
										...
										<input type="text" required  style="" name="reportrange" id="reportrange" class="form-control" value="<?php echo date('d/m/Y')?> - <?php echo date('d/m/Y')?>"/>  
									  </div>
									</div>										
								 </div>
