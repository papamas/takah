                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Pencatatan Hukuman Disiplin Pegawai Negeri Sipil 
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
								       <form method="post" action="<?php echo site_url()?>/hukuman/save/" data-toggle="validator" class="" role="form">
										...
										<div class="form-group row">
											...
											<div class='input-group date' id='datetimepicker1'>
												<input pattern="^\d{2}\-\d{1,2}\-\d{4}$" type='text' required name="sampai" id="sampai" value="<?php if($this->session->userdata('tgl')) echo $this->session->userdata('tgl'); else echo date('d-m-Y')?>" class="form-control" />
												<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
												</span>								
											</div>											            
                                           <span class="help-block with-errors"></span>
                                            ...
                                            <label class="control-label col-md-1 col-md-offset-1">Tingkat:</label>
                                            <div  class="col-md-4">
										 ...
										 <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
											<textarea name="jenis_hukuman" class="form-control" rows="3"></textarea>
											</div>
                                        </div>
