                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Pencatatan Pengadaan Calon Pegawai Negeri Sipil 
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
								       <form method="post" action="<?php echo site_url()?>/cpns/save/" data-toggle="validator" class="" role="form">
										...
										<div class="form-group row">
                                           ...
                                           <span class="help-block with-errors"></span>
                                            ...
                                            <label class="control-label col-md-1 col-md-offset-1">Nomor:</label>
                                            <div class="col-md-4">
