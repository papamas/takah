...
<script>	
	$(document).ready(function () {	
		...
		// event delete
		$("#update_pinjam").on("click",function(){
		    $('.msg').text('Updating Please Wait.....')
                      .removeClass( "text-green")
				      .addClass( "text-blue" ); 
						 
			var data = $('#form-pinjam').serialize();
			$.ajax({
				type: "POST",
				url : "<?php echo site_url()?>/pinjam/update",
				data: data,
				success: function(){
		...
		$("#delete-pinjam").on("click",function(){
		    $('.msg-del').text('Deleting Please Wait.....')
                         .removeClass( "text-green")
				         .addClass( "text-blue" ); 	
						 
			var data = $('#frmdel-pinjam').serialize();
			$.ajax({
				type: "POST",
				url : "<?php echo site_url()?>/pinjam/delete",
				data: data,
				success: function(){
